// Asset loading — mirrors TrueCarry_Sim exactly.
// All CC0 ground textures from Poly Haven, water normals from three.js examples (MIT).
...
export async function loadAssets(renderer) {
  ...
  satellite.wrapS = satellite.wrapT = THREE.ClampToEdgeWrapping;
