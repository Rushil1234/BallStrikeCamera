// Generates the Augusta replica ("Magnolia Hills") course modules from OSM data.
...
// Disguised plant-theme hole names (no official marks).
const NAMES = {
  1: 'SWEET OLIVE', 2: 'PINK DOGWOOD', 3: 'PEACH BLOSSOM', 4: 'CRABAPPLE',
  5: 'MAGNOLIA', 6: 'JUNIPER', 7: 'PAMPAS', 8: 'JASMINE', 9: 'CHERRY LANE',
  10: 'CAMELLIA', 11: 'DOGWOOD RUN', 12: 'BELLFLOWER', 13: 'AZALEA', 14: 'FIR',
...
const holesBody = `// Private local prototype of a famous Georgia parkland course ("Magnolia Hills").
// Local/internal development only; no official marks, imagery, or public nav exposure.
...
const osmBody = `// OSM golf geometry pulled from Overpass for the private Augusta prototype ("Magnolia Hills").
